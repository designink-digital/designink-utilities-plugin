...
if ( ! class_exists( 'Designink_Utilities_Jumpstart_Settings', false ) ) {

	/**
	 * Manage the JumpStart utilities for for this plugin.
	 */
	final class Designink_Utilities_Jumpstart_Settings extends Module {
		...
		final public static function get_use_jumpstart_option() {
			return get_option( sprintf( '_designink-settings_%s', self::SETTINGS_SECTION_NAME ) );
		}

		/**
		 * Get the Settings Module instance's Settings Page. Passes by reference.
		 * 
		 * return \Designink\WordPress\Framework\v1_0_1\Plugin\Admin\Designink_Settings_Page The Settings Page.
		 */
		final public static function &get_settings_page() {
			return Designink_Settings_Page_Module::$Settings_Page;
		}
