...
if ( ! class_exists( '\Designink\WordPress\v1_0_0\Action_Scheduler\Form_Builder', false ) ) {
	...
	final class Form_Builder {
		 ...
		 * 
		 * @return null|\Designink\WordPress\v1_0_0\Action_Scheduler\Timer The newly created/updated Timer instance.
		 */
